# Event Promotion Feature — Implementation Record

## Document Role
- **Purpose:** Spec and implementation tracker for the organiser/admin event promotion (bulk email) feature.
- **Status:** Implemented through the July 5 delivery fixes; residual follow-ups
  are tracked in `../improvement-plan/event-promotion-follow-ups.md`.
