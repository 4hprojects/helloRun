...
Use this file for dashboard-specific behavior, data sources, card ownership, status language, and implementation notes. Keep chronological implementation history in `docs/CHANGELOG.md`, and keep detailed submitted-entry page behavior in `docs/implementation/runner-submitted-entries.md`.
...
- `docs/implementation/runner-submitted-entries.md`
