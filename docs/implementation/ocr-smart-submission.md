...
Detailed planning source: `docs/implementation/ocr-smart-submission.md`
...
```md
Future enhancement: Smart OCR-based activity submission is planned under Phase 12. See `docs/implementation/ocr-smart-submission.md`.
```
