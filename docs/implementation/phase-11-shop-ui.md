# Phase 11 Shop UI — Implementation Record
...
- PRD reference: See `docs/PRD.md` Phase 11 and `docs/implementation/shop_feature.md` for full backend context.
