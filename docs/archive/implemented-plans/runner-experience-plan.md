# Runner Experience Improvements (Implemented Plan)
...
- PRD reference: See `docs/PRD.md` runner experience items and `docs/implementation/phase-11-shop-ui.md` for shop-related runner items.
