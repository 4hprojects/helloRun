# Organiser Experience Improvements (Implemented Plan)

## Document Role
- Purpose: Spec for organiser-facing UX gaps in event management — separate from the Phase 11 shop organiser surfaces.
- Status: Core listed work implemented June 22, 2026; retained as a design record.
- PRD reference: See `docs/PRD.md` organiser experience items and `docs/implementation/phase-11-shop-ui.md` for shop-specific organiser items.
