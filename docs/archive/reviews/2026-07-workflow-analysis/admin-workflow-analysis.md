# Admin Workflow and Mobile UX Analysis (Historical)
...
- Known error-surface issues and process risks: `docs/archive/reviews/2026-07-06-codebase-review/04-ux-intuitivity.md`, `docs/archive/reviews/2026-07-06-codebase-review/03-process-dx.md`.
