# User/Runner Workflow and Mobile UX Analysis (Historical)
...
**Friction:** identity/profile data is split between signup, quick profile, and the full profile. The user can understand that a field is missing without understanding why it matters later for certificates, emergency contact, or registration. Browser-default/plain-text authorization and rate-limit responses documented in `docs/archive/reviews/2026-07-06-codebase-review/04-ux-intuitivity.md` can abruptly remove navigation and recovery context.
...
- Known error-surface issues: `docs/archive/reviews/2026-07-06-codebase-review/04-ux-intuitivity.md`.
