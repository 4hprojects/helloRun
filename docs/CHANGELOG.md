...
- **Purpose:** chronological implementation history.
- **Current status:** see [STATUS.md](STATUS.md).
- **Forward priorities:** see [ROADMAP.md](ROADMAP.md).

---

> **This file is an index.** Full monthly records are in [changelog/](changelog/).
...
|--------|------|----------|
| September 2026 | [changelog/2026-09-september.md](changelog/2026-09-september.md) | 15 |
