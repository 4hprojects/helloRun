...
5. src/models/AccumulatedActivitySubmission.js
6. src/public/js/run-proof-modal.js
7. src/routes/organizer.routes.js
8. src/services/accumulated-activity.service.js
9. src/services/submission.service.js
10. src/views/organizer/submission-review.ejs
11. tests/submission.service.test.js
