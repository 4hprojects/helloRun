...
const TEMPO_RUN_VS_INTERVAL_RUN_COVER_IMAGE_URL = '/images/blog/covers/tempo-run-vs-interval-run.webp';
...
const POSTS = [
  ...
  {
    ...TEMPO_RUN_VS_INTERVAL_RUN_ARTICLE,
    contentHtml: TEMPO_RUN_VS_INTERVAL_RUN_PAYLOAD.contentHtml,
    coverImageUrl: TEMPO_RUN_VS_INTERVAL_RUN_COVER_IMAGE_URL,
    coverImageAlt: TEMPO_RUN_VS_INTERVAL_RUN_ARTICLE.coverImageAlt,
    ogImageUrl: TEMPO_RUN_VS_INTERVAL_RUN_COVER_IMAGE_URL,
    status: 'scheduled',
    publishedAt: '2026-11-11T11:00:00.000Z',
    featured: false,
    authorEmail: EXISTING_GUIDE_AUTHOR_EMAIL,
    links: ['/blog/tempo-run-explained','/blog/interval-running-for-beginners','/blog/easy-run-explained','/blog/what-is-a-running-base','/blog/how-to-build-a-weekly-running-schedule-around-work-or-school','/blog/10k-training-plan-for-beginners']
  },
  {
    ...HOW_TO_RUN_A_FASTER_5K_ARTICLE,
    contentHtml: HOW_TO_RUN_A_FASTER_5K_PAYLOAD.contentHtml,
    coverImageUrl: HOW_TO_RUN_A_FASTER_5K_COVER_IMAGE_URL,
    coverImageAlt: HOW_TO_RUN_A_FASTER_5K_ARTICLE.coverImageAlt,
    ogImageUrl: HOW_TO_RUN_A_FASTER_5K_COVER_IMAGE_URL,
    status: 'scheduled',
  ...
  {
    ...RUNNING_IN_COOL_WEATHER_PHILIPPINES_ARTICLE,
    contentHtml: RUNNING_IN_COOL_WEATHER_PHILIPPINES_PAYLOAD.contentHtml,
    coverImageUrl: RUNNING_IN_COOL_WEATHER_PHILIPPINES_COVER_IMAGE_URL,
    coverImageAlt: RUNNING_IN_COOL_WEATHER_PHILIPPINES_ARTICLE.coverImageAlt,
    ogImageUrl: RUNNING_IN_COOL_WEATHER_PHILIPPINES_COVER_IMAGE_URL,
    status: 'scheduled',
  ...
  {
    ...VIRTUAL_RUN_PARTICIPANT_RETENTION_ARTICLE,
    contentHtml: VIRTUAL_RUN_PARTICIPANT_RETENTION_PAYLOAD.contentHtml,
    coverImageUrl: VIRTUAL_RUN_PARTICIPANT_RETENTION_COVER_IMAGE_URL,
    coverImageAlt: VIRTUAL_RUN_PARTICIPANT_RETENTION_ARTICLE.coverImageAlt,
    ogImageUrl: VIRTUAL_RUN_PARTICIPANT_RETENTION_COVER_IMAGE_URL,
    status: 'scheduled',
  ...
  {
    ...VIRTUAL_RUN_METRICS_ORGANIZERS_SHOULD_TRACK_ARTICLE,
    contentHtml: VIRTUAL_RUN_METRICS_ORGANIZERS_SHOULD_TRACK_PAYLOAD.contentHtml,
    coverImageUrl: VIRTUAL_RUN_METRICS_ORGANIZERS_SHOULD_TRACK_COVER_IMAGE_URL,
    coverImageAlt: VIRTUAL_RUN_METRICS_ORGANIZERS_SHOULD_TRACK_ARTICLE.coverImageAlt,
    ogImageUrl: VIRTUAL_RUN_METRICS_ORGANIZERS_SHOULD_TRACK_COVER_IMAGE_URL,
    status: 'scheduled',
