...
const PRIVACY_RIGHTS = Object.freeze([
  ...
  { icon: 'cookie', title: 'Control browser storage', text: 'Essential security storage remains active. HelloRun manages Functional and Analytics per browser; Google separately controls advertising consent where applicable.', action: 'Cookie preferences', href: '/cookie-policy#cookie-choices' },
...
const COOKIE_CATEGORIES = Object.freeze([
  ...
  { icon: 'badge-ad', key: 'advertising', title: 'Advertising', state: 'Google managed', text: 'Google’s certified consent message and provider settings control configured AdSense consent where applicable; HelloRun does not offer a competing advertising toggle.' }
]);
...
const COOKIE_STORAGE_MATRIX = Object.freeze([
  ...
  { provider: 'HelloRun', name: 'hr.cookie_preferences', purpose: 'Remember this browser’s Functional and Analytics choices', technology: 'HTTP cookie', duration: 'Up to 12 months', category: 'Essential', removal: 'Clear site cookies; HelloRun optional categories return to off' },
  ...
  { provider: 'Google AdSense', name: 'Google advertising identifiers', purpose: 'Serve, measure, limit, and protect ads on configured pages after approval and activation', technology: 'First- and third-party cookies or similar storage', duration: 'Controlled by Google and user settings', category: 'Advertising', removal: 'Use Google’s certified consent message, browser controls, or Google Ads Settings' },
...
const COOKIE_CHOICE_GUIDANCE = Object.freeze([
  ...
  { icon: 'badge-x', title: 'Google advertising choice', text: 'Use Google’s certified consent message and provider controls where applicable. Manual HelloRun ad units remain disabled during approval preparation, without empty ad gaps.' }
]);
