...
router.post('/orders/:orderNumber/payment-proof', requireAuth, requireRunner, requireCsrfProtection, validateShopMutationPayload('paymentProof'), shopController.postOrderPaymentProof);
